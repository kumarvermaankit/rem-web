...
const DISPLAY_PRICES = {
  starter:  { USD: 4.99, INR: 399, GBP: 3.99, EUR: 4.99, AUD: 7.99, CAD: 6.99 },
  pro:      { USD: 9.99, INR: 799, GBP: 7.99, EUR: 9.99, AUD: 14.99, CAD: 12.99 },
  premium:  { USD: 19.99, INR: 1599, GBP: 15.99, EUR: 19.99, AUD: 29.99, CAD: 26.99 },
};
...
const plans = [
  {
    ...
    name: 'Starter',
    stars: 1,
    description: 'Essential reminders & lists for personal use',
    features: [
      'Unlimited reminders',
