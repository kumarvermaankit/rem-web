      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
            Your intelligent WhatsApp reminder and assistant bot. Set reminders, get notifications, and manage your tasks - all through WhatsApp.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            ...
            <button className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white/10 transition-colors flex items-center justify-center">
              Watch Demo
